...
export const saveRefreshToken = bind(function (tokenDoc, clientDoc, userDoc) {
  return collections.RefreshTokens.insert({
    refreshToken: tokenDoc.refreshToken,
    expires: tokenDoc.refreshTokenExpiresAt,
...
export const revokeToken = bind(function (token) {
  return collections.RefreshTokens.remove({ refreshToken: token })
})
